...
> دقت داشته باشید این اموزش فقط با Node.js v24.15 کار مییکنه (بدلیل اینکه شاید سخت باشه پیدا کردن نسخه دقیق با این اینترنت فایل نصبی برای شما قرار گرفته)  
...
## 🧩 مرحله 2: نصب کلاینت و آداپتور better-sqlite3

> ⚠️ دقیقا طبق مراحل پیش بروید.
